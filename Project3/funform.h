...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Location = System::Drawing::Point(299, 154);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(217, 165);
			this->button2->TabIndex = 1;
			this->button2->Text = L"button2";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &funform::button2_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(332, 338);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(163, 29);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Python Game ";
			// 
			// funform
			// 
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		Process::Start("https://replit.com/@SherifYato/WealthyDecimalSoftwareengineer#main.py");
	}
};
}
